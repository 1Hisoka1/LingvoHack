...
bot_token = '5253898179:AAGPHkF3RWvRSZyoDVkHx2EG6sGNrAKt0c4'
...
def ask_for_link(message):
    if message.text == 'Тесты':
        ...
        bot.send_message(message.chat.id, 'Для обратной связь писать сюда @ggomg1228, с пометкой\n"bot hakathon"')
